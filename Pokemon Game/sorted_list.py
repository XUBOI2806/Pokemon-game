...
__author__ = 'Maria Garcia de la Banda and Brendon Taylor. Modified by Alexey Ignatiev and Antony Razzell'
...
class ListItem(Generic[T, K]):
    ...
    def get_value(self) -> T:
        """
        This method is for aquiring the value field of a given ListItem
    ...
    def get_key(self) -> K:
        """
        This method is for aquiring the key field of a given ListItem
