...
class TestTask3(TesterBase):
    ...
    def test_battle_example(self):
        ...
        try:
            ...
            return
        try:
            with captured_output("0 1 0 0\n1 0 0 0") as (inp, out, err):
        ...
        try:
            assert str(b.team2) == "Charmander's HP = 7 and level = 2"
        except AssertionError:
            self.verificationErrors.append(f"Team 1 is not correct after battle: {str(b.team2)}")
